...
./scripts/monitor.sh polymarket 2026-01-14
```
...
./scripts/monitor_parquet.sh polymarket

# Monitor specific date
./scripts/monitor_parquet.sh polymarket 2026-01-14

# Watch mode (updates every 5 seconds)
./scripts/monitor_parquet.sh polymarket --watch
```
...
```bash
# Watch parquet files
watch -n 5 './scripts/monitor_parquet.sh polymarket'
